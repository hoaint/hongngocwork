...
class Genesis_Featured_Post extends WP_Widget {
	 ...
	 * @global array    $_news_displayed_ids Array of displayed post IDs.
	 * @global $integer $more
	 *
	...
	function widget( $args, $instance ) {
		...
		global $wp_query, $_news_displayed_ids;
		...
		if ( $instance['exclude_displayed'] )
			$query_args['post__not_in'] = (array) $_news_displayed_ids;

		$wp_query = new WP_Query( $query_args );

		if ( have_posts() ) : while ( have_posts() ) : the_post();

			$_news_displayed_ids[] = get_the_ID();
